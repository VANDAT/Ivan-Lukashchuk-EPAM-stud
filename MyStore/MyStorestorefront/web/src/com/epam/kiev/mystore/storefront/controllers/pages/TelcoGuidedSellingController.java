...
import com.epam.kiev.mystore.storefront.controllers.pages.AbstractSearchPageController;
import com.epam.kiev.mystore.storefront.controllers.util.GlobalMessages;
import com.epam.kiev.mystore.storefront.forms.UpdateQuantityForm;
import com.epam.kiev.mystore.core.model.ServicePlanModel;
import com.epam.kiev.mystore.facades.bundle.GuidedSellingFacade;
import com.epam.kiev.mystore.facades.bundle.GuidedSellingFacade.ProductType;
import com.epam.kiev.mystore.facades.data.BundleTabData;
import com.epam.kiev.mystore.facades.order.BundleCartFacade;
import com.epam.kiev.mystore.facades.product.TelcoProductFacade;
import com.epam.kiev.mystore.storefront.controllers.TelcoControllerConstants;
...
public class TelcoGuidedSellingController extends AbstractSearchPageController
{
	...
	protected String editPositionalComponent(final String bundleNo, final String componentId, final String searchQuery,
			...
			final int relativeposition) throws CMSItemNotFoundException
	{
