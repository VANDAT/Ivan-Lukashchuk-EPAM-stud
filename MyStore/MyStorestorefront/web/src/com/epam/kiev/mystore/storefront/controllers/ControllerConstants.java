 ...
 *  
 */
package com.epam.kiev.mystore.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String AccountOrganizationsPage = "pages/account/accountOrganizationsPage";
				String AccountAddOrganizationPage = "pages/account/accountAddOrganizationPage";
				String AccountCreateOrganizationPage = "pages/account/accountCreateOrganizationPage";
				String AccountUpdateOrganizationPage = "pages/account/accountUpdateOrganizationPage";
			}
