	...
	<div class="span-4 nav_column">
		...
		<div class="item">
			<ul class="facet_block indent">
				...
				<li class='${selected eq 'organizations' ? 'nav_selected' : ''}'>
					<c:url value="/my-account/organizations" var="encodedUrl" />
					<ycommerce:testId code="myAccount_organizations_navLink">
						<a href="${encodedUrl}" title="<spring:theme code="text.account.organizations" text="Organization info"/>"><spring:theme code="text.account.organizations" text="Organization info"/></a>
					</ycommerce:testId>
				</li>
