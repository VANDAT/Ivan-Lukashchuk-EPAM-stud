...
<div class="item_container_holder">
	...
	<form:form method="post" commandName="registerForm" action="${action}">
		<dl>
			...
			<formElement:formCheckboxes idKey="register.organizarion" labelKey="register.organizarion" path="organizations" mandatory="true" items="${organizations}" itemLabel="name" itemValue="id"/>
