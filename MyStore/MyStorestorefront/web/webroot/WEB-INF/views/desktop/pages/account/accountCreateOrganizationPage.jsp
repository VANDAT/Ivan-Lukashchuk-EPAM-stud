	...
	<div class="span-20 last cust_acc-page">
		<div class="item_container_holder">
			...
			<div class="item_container">
				...
				<form:form action="create-organization" method="post"
					commandName="organizationForm">
					<dl>
						<formElement:formInputBox idKey="account.organization.id"
							labelKey="account.organization.id" path="id" mandatory="true" />
					...
					<span style="display: block; clear: both;"> <ycommerce:testId
							code="profilePage_CreateOrganizationButton">
							<button class="form">
								<spring:theme
									code="text.account.organization.createOrganization"
