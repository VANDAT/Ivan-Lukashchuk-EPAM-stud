									...
									<td headers="header2"><ycommerce:testId
											...
											<ul class="updates">
												<li><ycommerce:testId
														...
														<a href="remove-organization/${organization.id}"
															class="actionlink"><spring:theme code="text.remove"
																text="Remove" /></a>
														<a href="edit-organization/${organization.id}"
															class="actionlink"><spring:theme code="text.edit"
																text="Edit" /></a>
													</ycommerce:testId></li>
											</ul>
										</ycommerce:testId></td>
				...
				<ycommerce:testId code="addressBook_addNewAddress_button">
					<a href="add-organization">
						<button class="positive left" type="submit">
							<spring:theme code="text.account.organizations.addOrganizations"
