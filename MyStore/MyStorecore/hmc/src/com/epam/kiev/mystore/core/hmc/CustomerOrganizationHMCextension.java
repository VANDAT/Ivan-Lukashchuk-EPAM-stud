package com.epam.kiev.mystore.core.hmc;
 ...
 * @version ExtGen v4.1
 */
public class CustomerOrganizationHMCextension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CustomerOrganizationHMCextension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.epam.kiev.mystore.core.hmc.locales";
