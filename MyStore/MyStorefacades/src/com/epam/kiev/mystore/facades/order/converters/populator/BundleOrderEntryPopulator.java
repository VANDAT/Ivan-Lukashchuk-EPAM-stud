 ...
 *  
 */
package com.epam.kiev.mystore.facades.order.converters.populator;
 ...
 * entry as Valid/Updateable/Removable/Editable.
 */
	...
	public void populate(final AbstractOrderEntryModel source, final OrderEntryData target)
	{
		...
		if (source.getOrder() != null && source.getOrder().getBillingTime() != null)
		{
			...
			if (source.getBundleTemplate() != null)
			{
				...
				{
					target.setRootBundleTemplate(getBundleTemplateConverter().convert(source.getBundleTemplate().getParentTemplate()));
				}
			}
		}
	}
