 ...
 *  
 */
package com.epam.kiev.mystore.facades.order;
...
public interface BundleCartFacade extends SubscriptionCartFacade
{
	 ...
	 * @throws CommerceCartModificationException
	 */
	List<CartModificationData> addToCart(String productCode1, int bundleNo, String bundleTemplateId1, String productCode2,
			String bundleTemplateId2) throws CommerceCartModificationException;
